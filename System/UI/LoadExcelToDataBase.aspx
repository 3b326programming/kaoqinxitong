...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <tr style="background-color:#3FF"><td><img src="images/more3.jpg" />导入教师基本信息</td></tr>
    ...
    <tr style="background-color:#3FF"><td><img src="images/more3.jpg" />分系部导入教师授课信息</td></tr>
    <tr><td td style="padding-left:200px"><asp:DropDownList ID="DropDownList1" runat="server" 
    ...
    <tr><td style="background-color:#3FF"><img src="images/more3.jpg" />导入本学期校历</td></tr>
   <tr><td>请选择要导入的文件<asp:FileUpload ID="FileUpload3" 
    ...
    <tr><td style="background-color:#3FF"><img src="images/more3.jpg" />录入各系部人数</td></tr>
    <tr><td>会计系
    ...
    <tr><td style="background-color:#3FF"><img src="images/more3.jpg" />数据预处理</td></tr>
